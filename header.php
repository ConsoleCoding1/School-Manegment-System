...
<body class="">
    <header class=" bg-linear-to-r from-yellow-400 via-orange-400 to-red-500 shadow-lg py-4">
        <div class="flex justify-between items-center max-w-7xl mx-auto px-8">
            ...
            <div class="flex">
                <a href="studentRegistration.php" class="md:block hidden mr-5 text-xl bg-linear-to-r from-blue-300 via-blue-400 to-red-500 text-white px-4 py-2 rounded-md hover:from-yellow-200 hover:via-blue-100 hover:to-red-300 transition duration-200 cursor-pointer">Registration</a>
                
                <!-- Dropdown menu -->
                <el-dropdown class="md:block hidden">
                    <button class="inline-flex w-full justify-center  gap-x-1.5 rounded-md bg-blue-500 px-3 py-2 text-xl font-semibold text-white inset-ring-1 inset-ring-white/5 hover:bg-blue-600 cursor-pointer transition duration-200">
                        Settings
                        <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="-mr-1 size-7 text-white">
        ...
        <nav id="mobileMenu" class="overflow-hidden transition-all duration-500 ease-in-out max-h-0 opacity-0 flex flex-col bg-linear-to-r from-yellow-400 via-orange-400 to-red-500  text-white text-lg font-medium px-8 py-2 space-y-3 md:hidden rounded-b-2xl">
            <a href="studentRegistration.php" class="mr-5 text-xl bg-linear-to-r from-blue-300 via-blue-400 to-red-500 text-white px-4 py-2 rounded-md hover:from-yellow-200 hover:via-blue-100 hover:to-red-300 transition duration-200 cursor-pointer">Registration</a>
