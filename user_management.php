...
<main class="flex flex-col justify-center items-center min-h-screen bg-linear-to-br from-red-400 via-orange-400 to-red-500">
    <form action="" method="post" class="bg-white px-10 py-15 rounded-2xl mt-5 mb-5">
        ...
        <div>
            ...
            <input type="text" id="user_name" name="user-name" class="border-3 border-<?php if($userNameError){ echo "red";}else{echo"blue";}?>-500 p-2 rounded w-96">
        ...
        <div class="mt-4">
            ...
            <input type="text" id="name" name="name" class="border-3 border-<?php if($NameError){ echo "red";}else{echo"blue";}?>-500 p-2 rounded w-full">
            <?php echo "<p class='text-red-500 text-xl'> $NameError</p>";?>
        </div>
        <div class="mt-4">
            <label for="user-role" class="block mb-2">User Role:</label>
            <input type="text" id="user_role" name="user-role" class="border-3 border-<?php if($userRoleError){ echo "red";}else{echo"blue";}?>-500 p-2 rounded w-full">
            <?php echo "<p class='text-red-500 text-xl'> $userRoleError</p>";?>
        </div>
        <div class="mt-4">
            <label for="user-created-at" class="block mb-2">Created at:</label>
            <input type="text" id="user_created_at" name="user-created-at" class="border-3 border-<?php if($createdAtError){ echo "red";}else{echo"blue";}?>-500 p-2 rounded w-full">
            <?php echo "<p class='text-red-500 text-xl'> $createdAtError</p>";?>
        </div>
        <div class="mt-4">
            <label for="user-created-by" class="block mb-2">Created by:</label>
            <input type="text" id="user_created_by" name="user-created-by" class="border-3 border-<?php if($createdByError){ echo "red";}else{echo"blue";}?>-500 p-2 rounded w-full">
